...
$sql = "SELECT * FROM ".$GLOBALS['xoopsDB']->prefix("forum_posts")." ORDER BY post_id DESC limit 0,5";
...
while ($row = $GLOBALS['xoopsDB']->fetchArray($result)) {
    ...
    $xoBile_link = new HAW_link($xoBile_link, "index.php?mod=d3forum&page=read&id=".$row['post_id']);
