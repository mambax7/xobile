...
$sql = "SELECT * FROM ".$GLOBALS['xoopsDB']->prefix("tdmdownloads_downloads")." ORDER BY lid DESC limit 0,5";
...
while ($row = $GLOBALS['xoopsDB']->fetchArray($result)) {
    ...
    $xoBile_link = new HAW_link($xoBile_link,"index.php?mod=TDMDownloads&page=view&id=".$row['lid']);
